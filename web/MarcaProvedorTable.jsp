...
<%
    ...
    ProductoList = new MarcaProvedorHelper( ).getList( );
...
%>
                <tbody>
                    <tr>
                        ...
                        <td>
                            <%=producto.getProvedor().getProvedor()%>
                        </td>
                         <td>
                            <a href="?action=delete&id=<%=producto.getIdProducto()%>">
                                <button type="button" class="btn btn-outline-primary "style="width:40px;height:40px;">
